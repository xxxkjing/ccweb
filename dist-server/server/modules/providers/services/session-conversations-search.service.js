...
export async function searchConversations(query, limit = 50, onProjectResult = null, signal = null) {
...
export const sessionConversationsSearchService = {
     ...
     */
    async search(input) {
        await searchConversations(input.query, input.limit, input.onProgress ?? null, input.signal ?? null);
    },
};
